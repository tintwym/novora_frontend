...
export const LEARNING_CHAMPIONS: LearningChampion[] = [
  { rank: '#1', name: 'Ahmad Wahid', role: 'Chief Executive Officer', classes: '5 classes', hours: '28 hrs', badge: '🏆 GOLD EDU-STAR' },
  { rank: '#2', name: 'David Ng', role: 'Head of Engineering', classes: '4 classes', hours: '22 hrs', badge: '🏆 SILVER MEDALIST' },
  { rank: '#3', name: 'Sarah Lim', role: 'Principal Engineer', classes: '3 classes', hours: '18 hrs', badge: '🏆 BRONZE RIBBON' },
  { rank: '#4', name: 'Sarah Lim Wei Ling', role: 'Senior Developer', classes: '3 classes', hours: '14 hrs', badge: '🏆 BRONZE RIBBON' },
]

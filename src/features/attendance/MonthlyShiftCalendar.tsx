    ...
    cells.push(
      <button
        ...
        className={`min-h-24 rounded-xl border p-2 text-left transition-all ${
          isSelected
            ? 'border-novora bg-novora/5 shadow-sm'
            : isToday
              ? 'border-novora/35 bg-white'
              : 'border-slate-100 bg-white hover:border-slate-200'
        }`}
      >
        <div className="flex items-center justify-between mb-1.5">
          <span className={`text-xs font-bold ${isToday ? 'text-novora' : 'text-slate-700'}`}>{day}</span>
          {isHr ? (
            <span
              role="button"
              tabIndex={0}
              ...
              className="h-5 w-5 rounded-md text-slate-300 hover:text-novora hover:bg-novora/10 inline-flex items-center justify-center"
            >
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-extrabold text-slate-900 tracking-tight inline-flex items-center gap-2">
              <CalendarIcon className="h-4 w-4 text-novora" />
      ...
      {selectedDate ? (
        <div className="nv-panel p-4 space-y-3">
          <div className="flex items-center justify-between gap-2">
            ...
            {isHr ? (
              <button type="button" onClick={() => openAssign(selectedDate)} className="text-xs font-bold text-novora">
                Add shift
              </button>
            ) : null}
          </div>

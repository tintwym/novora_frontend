    ...
    <div id="leave-module-root" className="space-y-6">
      ...
      <div id="leave-module-navigator" className="flex flex-col lg:flex-row lg:items-center justify-between border-b border-slate-200/85 pb-4 gap-4">
            ...
            return (
              ...
              >
                ...
                {isApproval && pendingCount > 0 && (
                  <span className="bg-amber-500 text-white text-[10px] font-black h-4.5 w-4.5 rounded-full flex items-center justify-center shrink-0">
                    {pendingCount}
                  </span>
                )}
              </button>
        ...
        <div id="leave-upper-actions" className="flex items-center gap-2.5 shrink-0 flex-nowrap">
          ...
          <button
            ...
            className="h-9 bg-novora text-white hover:bg-opacity-95 text-xs font-extrabold px-3.5 rounded-xl transition-all shadow-sm cursor-pointer inline-flex items-center gap-1.5 whitespace-nowrap shrink-0"
          >
                      ...
                      <td className="p-4 pr-6 text-right">
                        <div className="flex items-center justify-end gap-3 text-slate-400">
                          <button
                            ...
                            title="Edit"
                            className="p-1.5 rounded-lg text-slate-400 hover:text-novora hover:bg-slate-50 transition-colors cursor-pointer"
                          >
        ...
        <div className="space-y-6">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
            ...
            <button
              ...
              className="h-9 inline-flex items-center gap-1.5 px-4 text-xs font-bold text-white bg-novora hover:bg-opacity-95 rounded-xl shadow-xs cursor-pointer whitespace-nowrap shrink-0"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {leavePolicies.map((policy) => (
              <div key={policy.id} className="nv-card p-6 shadow-xs space-y-4 relative group hover:shadow-sm transition-all duration-250">
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  <h3 className="text-sm font-extrabold text-slate-850 tracking-tight">{policy.type} policy</h3>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="bg-white px-3 py-1.5 rounded-xl border border-slate-200 text-xs font-bold text-slate-700"
              >
                ...
                <tr className="bg-slate-50 border-b border-slate-100 text-[10px] font-bold text-slate-400 uppercase tracking-wider">
                  <th className="p-4 pl-6 w-12 text-center">
                    <input
                      ...
                      className="rounded border-slate-300 text-novora focus:ring-novora"
                    />
                  </th>
                    ...
                    <td className="p-4 pr-6 text-right">
                      {a.attached ? (
                        ...
                        <button
                          ...
                          className="bg-novora hover:bg-opacity-95 text-white px-3 py-1 rounded-lg font-bold text-[11px]"
                        >
                          Attach
                        </button>
                      )}
            ...
            <form onSubmit={handleSelfRequestSubmit} className="space-y-4">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className="rounded border-slate-300 text-novora"
                />
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <button
                  type="submit"
                  className="bg-novora hover:bg-opacity-95 text-white font-bold text-xs px-5 py-2.5 rounded-xl cursor-pointer transition-all flex-1 shadow-sm"
                >
                  Submit request
                </button>
              </div>
          ...
          <div className="lg:col-span-6 bg-white border border-slate-100 rounded-3xl p-6 shadow-xs space-y-5">
            ...
            <form onSubmit={handleRequestForOthersSubmit} className="space-y-4">
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <button
                  type="submit"
                  className="bg-blue-600 hover:bg-opacity-95 text-white font-bold text-xs px-5 py-2.5 rounded-xl cursor-pointer transition-all flex-1 shadow-sm"
                >
                  Submit request
                </button>
              </div>
                      ...
                      {r.status === 'Pending' ? (
                        <div className="flex items-center justify-end gap-2">
                          <button
                            ...
                            className="bg-emerald-600 hover:bg-opacity-95 text-white font-bold text-[11px] px-3 py-1.5 rounded-lg active:scale-95 transition-all"
                          >
                            Approve
                          </button>
                          <button
                      ...
                      {leaveSummaryRows
                        ...
                        .map(row => (
                          <tr key={row.employeeId} className="hover:bg-slate-50/40">
                            ...
                            <td className="p-3 text-center font-bold font-mono text-novora">{row.total} days</td>
                            <td className="p-3 text-right pr-4 text-slate-800 font-extrabold">
                              <span className="bg-emerald-50 text-emerald-800 border border-emerald-110 px-2 py-0.5 rounded-md font-extrabold">
                                {row.balance}
                              </span>
                            </td>
                          </tr>
      ...
      {newTypeModal && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="nv-card w-full max-w-sm p-6 shadow-xl space-y-4 animate-in fade-in zoom-in duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3">
              <h4 className="text-sm font-bold text-slate-850 tracking-tight flex items-center gap-1.5">
                <Settings className="h-4.5 w-4.5 text-novora" />
            ...
            <form onSubmit={handleCreateLeaveType} className="space-y-4">
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="bg-novora hover:bg-opacity-95 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs"
                >
                  Create Type
                </button>
              </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl w-full max-w-lg p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3.5">
              <h4 className="text-sm font-black text-slate-850 tracking-wider flex items-center gap-2">
                <FileText className="h-4.5 w-4.5 text-novora" />
            ...
            <form onSubmit={handleCreateLeavePolicy} className="space-y-4 text-xs">
              ...
              <div className="bg-slate-50/50 border border-slate-100 rounded-2xl p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="h-3.5 w-3.5 text-novora border-slate-350 rounded focus:ring-novora"
                  />
                </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="bg-novora hover:bg-opacity-95 text-white font-black text-xs px-5 py-2.5 rounded-xl shadow-md transition-all cursor-pointer"
                >
                  Create &amp; Apply Policy
                </button>
              </div>

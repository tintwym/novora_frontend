          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-slate-50 p-4 rounded-2xl border border-slate-100">
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="bg-[#2f66e0] text-white hover:bg-opacity-95 text-xs font-bold px-4.5 py-1.5 rounded-xl cursor-pointer"
              >
                Manual attach
              </button>
            </div>
                    ...
                    <td className="p-4 pr-6 text-right">
                      {a.attached ? (
                        ...
                        <button
                          ...
                          className="bg-[#2f66e0] hover:bg-opacity-95 text-white px-3 py-1 rounded-lg font-bold text-[11px]"
                        >
                          Attach
                        </button>
                      )}
          ...
          <div className="lg:col-span-6 bg-white border border-slate-150 rounded-3xl p-6 shadow-xs space-y-5">
            ...
            <form onSubmit={handleSelfRequestSubmit} className="space-y-4">
              ...
              <div className="pt-2 flex items-center gap-3">
                ...
                <button
                  type="submit"
                  className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-bold text-xs px-5 py-2.5 rounded-xl cursor-pointer transition-all flex-1 shadow-sm"
                >
                  Submit request
                </button>
              </div>
          ...
          <div className="bg-white border border-slate-100 rounded-xl p-4 shadow-sm flex flex-col sm:flex-row flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2.5 w-full sm:w-auto text-slate-700 font-sans">
              ...
              <button
                ...
                className="bg-[#2f66e0] text-white hover:bg-opacity-95 text-xs font-extrabold px-3.5 py-2.5 rounded-xl transition-all shadow-sm flex items-center gap-1.5 cursor-pointer ml-auto sm:ml-0"
              >
          ...
          <div className="bg-white border border-slate-100 rounded-2xl w-full max-w-sm p-6 shadow-xl space-y-4 animate-in fade-in zoom-in duration-200">
            ...
            <form onSubmit={handleCreateLeaveType} className="space-y-4">
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-bold text-xs px-4 py-2 rounded-xl shadow-xs"
                >
                  Create Type
                </button>
              </div>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl w-full max-w-lg p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in duration-200 max-h-[90vh] overflow-y-auto">
            ...
            <form onSubmit={handleCreateLeavePolicy} className="space-y-4 text-xs">
              ...
              <div className="bg-slate-50/50 border border-slate-150 rounded-2xl p-4 space-y-3">
                <div className="flex items-center justify-between">
                  ...
                  <input
                    ...
                    className="h-3.5 w-3.5 text-[#2f66e0] border-slate-350 rounded focus:ring-[#2f66e0]"
                  />
                </div>
              ...
              <div className="pt-2 flex items-center justify-end gap-2.5">
                ...
                <button
                  type="submit"
                  className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-black text-xs px-5 py-2.5 rounded-xl shadow-md transition-all cursor-pointer"
                >
                  Create &amp; Apply Policy
                </button>
              </div>

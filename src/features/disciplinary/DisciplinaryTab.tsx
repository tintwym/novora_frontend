...
export default function DisciplinaryTab({ employees, addToast }: DisciplinaryTabProps) {
  ...
  const handleSaveEditReason = (e: React.FormEvent) => {
    e.preventDefault();
  ...
  const handleSaveCase = (e: React.FormEvent) => {
    ...
    setActiveSubTab('Disciplinary History');
  };
                  ...
                  {actions
                    ...
                    .map((a) => (
                      <tr key={a.level} className="hover:bg-slate-50/40">
                        <td className="p-4 pl-5 font-bold text-novora font-mono">{a.level}</td>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-50 border border-slate-200 pl-9.5 pr-3 py-2 text-xs font-bold rounded-xl focus:outline-none focus:bg-white focus:border-novora"
                  />
                </div>
              </div>
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <select
                  ...
                  className="w-full bg-slate-50 border border-slate-200 p-2.5 text-xs font-bold rounded-xl focus:outline-none focus:bg-white focus:border-novora min-h-16"
                >
                  {employees
              ...
              <div className="space-y-1.5 sm:col-span-2">
                ...
                <div
                  ...
                  className="border-2 border-dashed border-slate-200 hover:border-novora/40 rounded-2xl p-5 text-center transition-all bg-slate-50/20 cursor-pointer relative group"
                >
                  <input
                    type="file"
                    id="doc-file-upload"
                  ...
                  <div className="flex flex-col items-center gap-1.5 select-none text-slate-600">
                    ...
                    {attachedFileName ? (
                      <div>
                        <span className="text-xs font-extrabold text-novora block">{attachedFileName}</span>
                        ...
                        <tr key={item.id} className="hover:bg-slate-50/40">
                          ...
                          <td className="p-4 pl-5">
                            <div className="flex items-center gap-3">
                              <div className="h-8.5 w-8.5 rounded-full bg-slate-100 text-novora font-bold text-xs flex items-center justify-center border border-slate-200 shrink-0">
                          ...
                          <td className="p-4 text-right pr-5">
                            <div className="flex items-center justify-end gap-1.5">
                              <button
                                ...
                                className="text-slate-500 hover:text-novora font-bold text-xs bg-slate-50 hover:bg-novora/10 border border-slate-100 p-1.5 rounded-lg transition-all flex items-center gap-1 cursor-pointer"
                              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <div className="nv-card p-4 shadow-sm flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <h3 className="text-xl font-extrabold text-novora tracking-tight">{resolveRate}%</h3>
                  <span className="text-[9px] font-bold text-emerald-500 bg-emerald-55/60 px-2 py-0.5 rounded-md border border-emerald-110">&bull; {closedCases} of {totalCases} closed</span>
                </div>
              ...
              <div className="nv-card p-4 shadow-sm flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <span className="text-[9px] font-bold text-amber-500 bg-amber-55/60 px-2 py-0.5 rounded-md border border-amber-110">{pendingCases} pending action</span>
                </div>
              ...
              <div className="nv-card p-4 shadow-sm flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <span className="text-[9px] font-bold text-rose-500 bg-rose-55/60 px-2 py-0.5 rounded-md border border-rose-110">Immediate attention</span>
                </div>
              ...
              <div className="nv-card p-4 shadow-sm flex items-center justify-between">
                <div className="space-y-1 font-sans">
                  ...
                  <span className="text-[9px] font-bold text-indigo-500 bg-indigo-55/60 px-2 py-0.5 rounded-md border border-indigo-110">Overall records</span>
                </div>
                ...
                <table className="w-full text-left text-xs text-slate-700 min-w-175">
                  ...
                  <tbody className="divide-y divide-slate-100 font-medium">
                    {departmentalData.map((data) => {
                      const healthBadge =
                        data.riskAssessment === 'Normal'
                          ? 'bg-emerald-50 text-emerald-700 border-emerald-100'
                          : data.riskAssessment === 'Under Watch'
                    ...
                    <tbody className="divide-y divide-slate-100 font-medium">
                      {cases
                        ...
                        .map(item => {
                          ...
                          return (
                            <tr key={item.id} className="hover:bg-slate-50/40">
                              <td className="p-3 pl-4 font-mono text-[10.5px] font-bold text-novora">{item.id}</td>
                              <td className="p-3">
                    ...
                    <tbody className="divide-y divide-slate-100 font-medium">
                      {summaryRecords.map(row => {
                        const evaluationBadge =
                          row.totalCases === 0
                            ? 'bg-emerald-50 text-emerald-700 border-emerald-100'
                            : ['L4', 'L5', 'L6'].includes(row.maxLevel)
          ...
          <div className="bg-white border border-slate-100 rounded-3xl w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
              <h4 className="text-xs font-bold text-slate-800 uppercase tracking-widest flex items-center gap-2">
                <PlusCircle className="h-4.5 w-4.5 text-novora" />
            ...
            <form onSubmit={handleAddReason} className="space-y-4 font-sans">
              ...
              <div className="flex justify-end gap-2.5 pt-2 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  className="px-4 py-2 text-xs font-bold text-white bg-novora hover:bg-opacity-95 rounded-xl cursor-pointer shadow-tinier"
                >
                  Save Reason
                </button>
              </div>
      ...
      {editingReason && (
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-slate-100 rounded-3xl w-full max-w-md p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-4">
              <h4 className="text-xs font-bold text-slate-800 uppercase tracking-widest flex items-center gap-2">
                <Scale className="h-4.5 w-4.5 text-novora" />
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <div className="bg-white border border-slate-100 rounded-3xl w-full max-w-2xl p-6 shadow-2xl animate-in fade-in zoom-in-95 duration-200 overflow-y-auto max-h-[90vh]">
            <div className="flex items-center justify-between border-b border-slate-100 pb-3 mb-5">
              <div>
                <span className="text-[10px] font-mono font-bold text-novora bg-blue-50/70 border border-blue-100 px-2.5 py-0.5 rounded-md">
              ...
              <div className="space-y-3 pt-1">
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                  <div>
                    ...
                    <span className="text-novora font-bold block mt-0.5">{viewCaseDetailsModal.reason}</span>
                  </div>
                  <div>

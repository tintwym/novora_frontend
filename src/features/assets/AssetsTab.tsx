...
export default function AssetsTab({ employees, addToast }: AssetsTabProps) {
  ...
  const handleApproveRequest = (req: any) => {
    ...
    if (availableMatch) {
      ...
      const newAsset = {
        ...
        serialNum: `PRV-${createLocalId('sn')}`,
  ...
  return (
    <div id="assets-management-view" className="space-y-6">
        ...
        <div className="flex items-center gap-2 pb-2 sm:pb-0">
          ...
          {activeSubTab === 'Registry' && (
            <button
              ...
              className="h-8.5 px-3 bg-novora hover:bg-[#2051c2] text-white rounded-xl text-[11px] font-bold inline-flex items-center gap-1 cursor-pointer transition-all active:scale-97"
            >
      ...
      <div id="assets-management-table-card" className="nv-card shadow-xs overflow-hidden">
                      ...
                      <tr key={asset.id} className="hover:bg-slate-50 transition-colors">
                        ...
                        <td className="py-3.5 px-4">
                          <div className="max-w-xs sm:max-w-md">
                            <p className="font-bold text-slate-800 break-words hover:text-novora cursor-pointer" onClick={() => setDetailDrawerItem(asset)}>
                              {asset.name}
                            </p>
          ...
          <div id="assets-detail-drawer-body" className="w-full max-w-lg bg-white h-full shadow-2xl flex flex-col justify-between p-6 overflow-y-auto animate-slide-in">
            ...
            <div className="pt-6 border-t flex gap-2">
              ...
              <button
                id="drawer-btn-close"
                onClick={() => setDetailDrawerItem(null)}
                className="flex-1 py-1 bg-novora hover:bg-[#2051c2] text-white text-xs font-bold rounded-xl cursor-pointer text-center transition-all"
              >
                Done
              </button>
            </div>
              ...
              <form onSubmit={handleSaveAsset} className="space-y-4">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs border border-slate-200 outline-none p-2 rounded-xl focus:border-novora font-mono font-medium text-slate-800 bg-white"
                      />
                    </div>
                    <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs border border-slate-200 outline-none p-1.5 rounded-xl focus:border-novora font-medium text-slate-700 bg-white cursor-pointer"
                      />
                    </div>
                  </div>
                ...
                <div className="pt-3 border-t flex justify-end gap-2 text-xs">
                  ...
                  <button
                    id="btn-asset-submit"
                    type="submit"
                    className="px-4 py-2 bg-novora hover:bg-[#2051c2] text-white font-bold rounded-xl transition-all cursor-pointer"
                  >
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full text-xs border border-slate-200 outline-none p-2 rounded-xl focus:border-novora font-mono font-medium text-slate-800 uppercase bg-white"
                    />
                  </div>
                  <div>

              ...
              <form onSubmit={handleSaveAsset} className="space-y-4">
                ...
                <div className="pt-3 border-t flex justify-end gap-2 text-xs">
                  ...
                  <button
                    id="btn-asset-submit"
                    type="submit"
                    className="px-4 py-2 bg-[#2f66e0] hover:bg-[#2051c2] text-white font-bold rounded-xl transition-all cursor-pointer"
                  >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full text-xs border border-slate-200 outline-none p-2 rounded-xl focus:border-blue-500 font-medium text-slate-850 bg-white"
                      />
                    </div>
                  </div>

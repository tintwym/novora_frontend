  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-50 font-sans px-6">
      <div className="w-full max-w-md animate-soft-fade-up text-center space-y-6">
        ...
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-full bg-novora/10 text-novora">
        ...
        <div className="space-y-2.5">
          <button
            ...
            className="inline-flex w-full items-center justify-center gap-2 rounded-xl bg-novora px-4 py-3 text-sm font-bold text-white hover:bg-[#2554c0] disabled:opacity-60"
          >

        ...
        <div className="pt-1 space-y-1.5">
          <label className="flex items-start gap-2.5 text-xs font-medium text-slate-600 cursor-pointer">
            <input
              ...
              className="mt-0.5 h-3.5 w-3.5 rounded border-slate-300 text-novora focus:ring-novora"
            />
            <span>
              I agree to the{' '}
              <span className="font-semibold text-novora">Terms of Service</span> and{' '}
              <span className="font-semibold text-novora">Privacy Policy</span>
            </span>
          </label>

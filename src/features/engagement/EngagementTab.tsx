...
export default function EngagementTab({ employees, addToast }: EngagementTabProps) {
  ...
  return (
    <div id="engagement-management-component-root" className="space-y-6">
      ...
      <div id="engagement-navigator-row" className="flex flex-col lg:flex-row lg:items-center justify-between border border-slate-100 bg-white px-4 py-1.5 rounded-2xl gap-3">
            ...
            <div className="lg:col-span-2 space-y-4">
              ...
              <div className="space-y-4">
                {suggestions.map((entry) => (
                  <div key={entry.id} className="bg-white border border-slate-100 rounded-2xl p-6 shadow-xs hover:shadow-2xs hover:border-slate-205 transition-all flex flex-col md:flex-row gap-5 justify-between">

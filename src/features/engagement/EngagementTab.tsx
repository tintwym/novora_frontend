...
export default function EngagementTab({ employees, addToast }: EngagementTabProps) {
  ...
  return (
    <div id="engagement-management-component-root" className="space-y-6">
      ...
      <div id="engagement-navigator-row" className="flex flex-col lg:flex-row lg:items-center justify-between gap-3 border-b border-slate-200/85 pb-4">
        ...
        <div id="subview-pulse-enps" className="space-y-6">
          ...
          <div className="nv-card p-6.5 shadow-xs">
            <div className="flex justify-between items-center mb-5 border-b border-slate-50 pb-4">
              ...
              <span className="text-[11px] font-black text-novora bg-novora/10 px-3 py-1 rounded-full inline-flex items-center whitespace-nowrap shrink-0">
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center justify-between text-[11px] font-bold text-slate-700">
                                <span>{opt.label}</span>
                                <span className="font-extrabold text-novora shrink-0">{optPct}%</span>
                              </div>

                              <div className="w-full bg-slate-100 mt-1.5 h-1 rounded-full overflow-hidden">
                                <div className="bg-novora h-full" style={{ width: `${optPct}%` }} />
                              </div>
                            </button>
                          );
                        })}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="nv-card p-6 shadow-xs space-y-4">
                <div className="flex items-center gap-2">
                  <Lightbulb className="h-5 w-5 text-novora" />
                  ...
                  <div key={entry.id} className="nv-card p-6 shadow-xs hover:shadow-2xs hover:border-slate-205 transition-all flex flex-col md:flex-row gap-5 justify-between">
                    <div className="space-y-3.5">
                      ...
                      <div className="bg-slate-50 p-3 rounded-xl border border-slate-100 text-[10.5px] text-slate-500 flex items-center gap-2">
                        <Activity className="h-3.5 w-3.5 text-novora shrink-0" />
      ...
      {activeSubTab === 'Peer Shout-Out Wall' && (
        <div id="subview-shoutouts" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-4">
              <div className="flex justify-between items-center bg-blue-50/10 border border-novora/15 p-4 rounded-xl">
                <div className="flex items-center gap-2.5">
                  <Sparkles className="h-4 w-4 text-novora animate-pulse" />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {shoutOuts.map((card) => (
                  <div key={card.id} className="bg-white border border-slate-100 p-5 rounded-2xl shadow-xs hover:shadow-2xs transition-all flex flex-col justify-between">
                    <div>
                      {/* Card Header information */}
                      <div className="flex justify-between items-start gap-2 mb-3.5">
                        <div className="flex items-start gap-2.5">
                          <div className="h-8.5 w-8.5 rounded-xl bg-gradient-to-tr from-novora/10 to-indigo-100/30 text-novora flex items-center justify-center font-extrabold text-[12.5px] border border-novora/10 shrink-0">
      ...
      {activeSubTab === 'Manager Sentiment Desk' && (
        <div id="subview-managerial-desk" className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            ...
            <div className="bg-white border border-slate-100 p-5 rounded-2xl shadow-xs flex items-center gap-4.5">
              <span className="p-3 bg-indigo-50 text-novora rounded-xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1">
              <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-xs space-y-4">
                <div className="flex items-center gap-2">
                  <Target className="h-5 w-5 text-novora" />
                    ...
                    >
                      <div className="space-y-1.5">
                        <div className="flex items-center gap-2.5 flex-wrap">
                          ...
                          <span className="text-[10px] text-novora bg-blue-50 px-2 py-0.5 rounded font-black uppercase">
                      ...
                      <div className="shrink-0 flex items-center gap-3 self-end sm:self-auto browser-safari-override">
                        <button
                          ...
                          className={`text-[10.5px] font-black px-3 py-1.5 rounded-xl border cursor-pointer select-none transition-all active:scale-95 ${
                            ...
                            plan.status === 'In Progress' ? 'bg-blue-50 text-novora border-blue-200' :
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-3xs">
              ...
              <div className="w-full bg-slate-100 h-1 rounded-full overflow-hidden mt-3.5">
                <div className="bg-novora h-full w-[85%]" />
              </div>
            </div>

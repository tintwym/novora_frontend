...
export default function LearningTab({ employees, addToast }: LearningTabProps) {
  ...
  const handleSimulatedLmsImport = (e: React.FormEvent) => {
    e.preventDefault();
    if (!scormTitle.trim()) {
    ...
    <div id="learning-management-module-root" className="space-y-6">
        ...
        <div id="learning-catalog-pane" className="space-y-6">
          ...
          {isLmsModalOpen && (
            <div className="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center p-4">
              <div className="nv-card max-w-md w-full p-6 shadow-xl space-y-4">
                <div className="flex justify-between items-center border-b border-slate-50 pb-3">
                  <div className="flex items-center gap-2">
                    <Upload className="h-5 w-5 text-novora" />
                ...
                <form onSubmit={handleSimulatedLmsImport} className="space-y-4">
                  ...
                  <div className="border border-dashed border-slate-200 rounded-xl p-4 text-center bg-slate-50/55">
                    <Download className="h-6 w-6 text-novora mx-auto opacity-70" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {filteredCourses.map((course) => (
              <div key={course.id} className="bg-white border border-slate-100 p-5 rounded-2xl shadow-xs hover:shadow-2xs transition-all flex flex-col justify-between">
                <div>
                  
                  {/* Category + Rating metadata row */}
                  <div className="flex items-center justify-between gap-2 mb-3">
                    <span className="text-[9.5px] font-black uppercase tracking-wider px-2.5 py-0.5 rounded-md bg-blue-50 text-novora border border-blue-100/50">
                      {course.category}
                    </span>
                  ...
                  <div className="grid grid-cols-3 gap-1.5 py-3.5 border-y border-slate-50 my-4 text-center">
                    ...
                    <div>
                      ...
                      <span className="text-[10.5px] font-black text-novora truncate block">{course.source.split(' ')[0]}</span>
                    </div>
                  </div>
                  ...
                  {course.enrolled && (
                    <div className="space-y-1 my-3">
                      <div className="flex justify-between items-center text-[10.5px] font-bold text-slate-600">
                        ...
                        <span className="font-mono text-novora">{course.progress}%</span>
                      </div>
                      ...
                      <>
                        ...
                        {course.progress < 100 ? (
                          <button
                            ...
                            className="px-3 py-1.5 bg-novora hover:bg-opacity-95 text-white text-[10px] font-black rounded-lg transition-all cursor-pointer flex items-center gap-1"
                          >
        ...
        <div id="learning-paths-pane" className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <button
              ...
              className="bg-novora hover:bg-opacity-95 text-white font-extrabold text-xs px-4.5 py-2.5 rounded-xl flex items-center gap-2 cursor-pointer transition-all shrink-0"
            >
          ...
          {isPathCreatorOpen && (
            <div className="bg-white border border-novora/20 rounded-2xl p-6 shadow-sm space-y-4 max-w-2xl">
              <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                <div className="flex items-center gap-2.5">
                  <Sliders className="h-5 w-5 text-novora" />
                      ...
                      return (
                        <button
                          ...
                          className={`w-full text-left p-2 border rounded-lg text-[10.5px] font-bold flex items-center justify-between transition-colors ${
                            isSelected 
                              ? 'bg-blue-50/55 border-novora/30 text-slate-800' 
                              : 'bg-white border-slate-100 hover:bg-slate-50/50 text-slate-600'
                          }`}
                        >
                          <span className="truncate">{course.title}</span>
                          <span className="shrink-0 ml-2 font-mono text-[9px] text-novora">
              ...
              <div key={path.id} className="nv-card p-6.5 shadow-xs hover:border-slate-205 transition-all flex flex-col justify-between">
                <div>
                  ...
                  <div className="flex justify-between items-center mb-4">
                    <div className="flex items-center gap-2">
                      <span className="text-[10px] font-extrabold bg-novora/10 text-novora px-3 py-1 rounded-full uppercase tracking-wider inline-flex items-center whitespace-nowrap shrink-0">
                ...
                <div className="mt-6 pt-4 border-t border-slate-50 flex items-center justify-between text-[11px]">
                  ...
                  <button
                    ...
                    className="bg-novora/10 hover:bg-novora/20 text-novora font-extrabold px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                  >
                    Force Batch Assign
                  </button>
                </div>
      ...
      {activeSubTab === 'Compliance & Certifications' && (
        <div id="learning-compliance-pane" className="space-y-6">
          ...
          <div className="nv-card p-5 shadow-xs">
                      ...
                      <td className="py-3 px-3 text-right">
                        <div className="flex justify-end gap-1.5">
                          ...
                          <button
                            ...
                            className="bg-novora/10 hover:bg-novora/20 text-novora font-black text-[10px] px-2 py-1 rounded transition-colors cursor-pointer"
                          >
                            Renew File
                          </button>
                        </div>
                  ...
                  return (
                    ...
                    >
                      <div className="flex justify-between items-center w-full mb-1">
                        <span className="text-[10px] font-mono text-novora font-black uppercase bg-novora/5 px-2 py-0.5 rounded">
                          {quiz.id}
                        </span>
            ...
            <div className="lg:col-span-2">
              {activeQuizToTake ? (
                <div className="bg-white border border-slate-100 p-6 rounded-2xl shadow-xs space-y-5">
                  <div className="flex justify-between items-center border-b border-slate-100 pb-3">
                    <div>
                      <span className="text-[9px] font-black text-novora uppercase tracking-widest block">Active Testing Session Enforced</span>
                      ...
                      {activeQuizToTake.questions.map((q, index) => {
                        ...
                        return (
                          <div key={q.id} className="p-4 bg-slate-50/50 border border-slate-100 rounded-xl space-y-3">
                            <span className="text-[10px] font-mono text-novora font-black uppercase tracking-wider block">
                                ...
                                return (
                                  <button
                                    ...
                                    className={`p-3 text-left border rounded-xl text-[10.5px] font-bold flex items-center justify-between transition-all cursor-pointer ${
                                      isChecked 
                                        ? 'bg-blue-50/50 border-novora/40 text-novora' 
                                  ...
                                  >
                                    ...
                                    <div className="h-4 w-4 rounded-full border border-slate-300 flex items-center justify-center shrink-0">
                                      {isChecked && <div className="h-2 w-2 rounded-full bg-novora items-center shrink-0" />}
                                    </div>
                                  </button>
                                );
                              })}
        ...
        <div id="learning-analytics-pane" className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 nv-card p-6.5 shadow-xs flex flex-col justify-between">
              <div>
                <div className="flex justify-between items-start mb-4 border-b border-slate-50 pb-3">
                  ...
                  <span className="text-[10px] font-black text-novora bg-novora/10 px-2.5 py-1 rounded-full uppercase tracking-wider inline-flex items-center whitespace-nowrap shrink-0">
                    Target: 80% Min
                  </span>
                </div>
                    ...
                    return (
                      <div key={dept} className="space-y-1">
                        ...
                        <div className="w-full bg-slate-50 border border-slate-100 rounded-full h-3 overflow-hidden flex">
                          <div className="bg-novora h-full rounded-l-full transition-all" style={{ width: `${completionRate}%` }} />
                          <div className="bg-novora/30 h-full transition-all" style={{ width: `${100 - completionRate}%` }} />
                        </div>
                      </div>
                    );
                  })}
            ...
            <div className="nv-card p-6.5 shadow-xs flex flex-col justify-between">
              ...
              <div className="bg-blue-50/25 border border-blue-100/50 p-3.5 rounded-xl text-[10.5px] text-novora leading-snug font-medium mt-4">
                ...
                return (
                  <div key={emp.id} className="p-4 rounded-xl border border-slate-100 flex items-center gap-3 hover:border-slate-205 transition-colors">
                    ...
                    <div>
                      ...
                      <span className="text-[9px] font-black uppercase text-novora tracking-wide block mt-1">
                        🏆 {activeBadge}
                      </span>
                    </div>
                  </div>

      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 bg-white p-5 rounded-2xl border border-slate-100">
        ...
        <div className="flex items-center gap-3 shrink-0">
          <button
            ...
            className="bg-[#2f66e0] hover:bg-opacity-90 font-bold text-xs text-white px-4 py-2.5 rounded-xl transition-all shadow-xs flex items-center gap-2 cursor-pointer"
          >

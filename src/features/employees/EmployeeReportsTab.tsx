...
export default function EmployeeReportsTab({ employees, addToast }: EmployeeReportsTabProps) {
    ...
    <div id="employees-reports-tab-container" className="space-y-6 animate-in fade-in duration-150">
      ...
      <div className="bg-slate-50 border border-slate-100 p-5 rounded-3xl flex flex-col md:flex-row gap-4 items-center justify-between shadow-xs">
        ...
        <div className="flex items-center gap-2.5 w-full md:w-auto md:justify-end border-t md:border-t-0 pt-4 md:pt-0 border-slate-100">
          ...
          <button
            ...
            className="flex-1 md:flex-initial bg-novora hover:bg-opacity-95 text-[11px] font-extrabold text-white px-4 py-2 rounded-xl flex items-center justify-center gap-1.5 transition-colors cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-xs relative overflow-hidden">
          ...
          <div className="flex items-center gap-1 mt-3">
            <span className="h-1.5 w-1.5 rounded-full bg-novora items-center shrink-0" />
        ...
        <div className="bg-white border border-slate-100 rounded-3xl p-5 shadow-xs relative overflow-hidden">
          ...
          <div className="flex items-baseline gap-2 mt-1.5">
            <span className="text-3xl font-black text-novora">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
        ...
        <div className="lg:col-span-6 bg-white border border-slate-100 rounded-3xl p-6 shadow-xs space-y-5">
          <div className="border-b border-slate-50 pb-3">
            <h3 className="text-xs font-bold text-slate-850 uppercase tracking-wider">Internal Roster Distribution by Department</h3>
        ...
        <div className="lg:col-span-6 space-y-6">
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-xs">
            <div className="border-b border-slate-50 pb-3 mb-4">
              <h3 className="text-xs font-bold text-slate-850 uppercase tracking-wider">Internal Service Longevity / Tenure Breakdown</h3>
          ...
          <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-xs space-y-4">
            ...
            <div className="w-full h-4.5 bg-slate-100 rounded-lg overflow-hidden flex font-bold text-[8.5px] text-white select-none">
              <div 
                className="bg-novora h-full flex items-center justify-center transition-all" 
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-[10.5px] font-bold">
              <div className="flex items-center gap-1.5 text-slate-600">
                <span className="h-2 w-2 rounded-full bg-novora items-center shrink-0" />
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="bg-slate-50 border border-slate-200 focus:border-slate-350 rounded-xl pl-8.5 pr-7 py-1.5 text-xs font-semibold text-slate-700 outline-none w-60"
              />
              {reportSearchQuery && (
                <button
            ...
            <button
              ...
              className="bg-slate-55 hover:bg-slate-100 border border-slate-200 text-slate-600 font-bold text-xs px-3.5 py-1.5 rounded-xl flex items-center gap-1.5 cursor-pointer transition-all"
            >
              ...
              {filteredEmployees.map((emp) => (
                <tr key={emp.id} className="hover:bg-slate-50/30 transition-colors">
                  ...
                  <td className="py-3.5 px-4.5">
                    ...
                    <span className="text-[10px] text-novora bg-blue-50 px-2 py-0.5 rounded font-bold inline-block mt-0.5">{emp.department}</span>
                  </td>
                  <td className="py-3.5 px-4.5">

...
export default function OrgChartTab({ employees, onSelectEmployee, addToast }: OrgChartTabProps) {
  ...
  const getDeptColorTheme = (dept: string) => {
    switch (dept) {
      ...
      case 'Marketing':
        return {
          cardBg: 'bg-rose-50/70 border-rose-250 border-rose-150 hover:border-rose-350',
  ...
  const renderNodeCard = ({ name, role, id, dept, members, isCEO = false }: NodeCardProps) => {
    ...
    return (
      <div
        ...
        className={`flex items-center gap-2.5 bg-white shadow-xs hover:shadow-md transition-all cursor-pointer relative ${
          density.nodeWidth
        } ${theme.cardBg} ${highlighted ? 'ring-4 ring-novora' : ''}`}
      >
  ...
  const renderSubNodeCard = ({ name, role, id, dept }: SubNodeCardProps) => {
    const theme = getDeptColorTheme(dept);
    const highlighted = isHighlighted(name, role);
    ...
    return (
      <div
        ...
        } ${theme.cardBg} ${highlighted ? 'ring-2 ring-novora' : ''}`}
      >
  ...
  const renderSubSubNodeCard = ({ name, role, id, dept }: SubNodeCardProps) => {
    const theme = getDeptColorTheme(dept);
    const highlighted = isHighlighted(name, role);
  ...
  return (
    <div id="org-chart-tab-outer" className="space-y-6">
            ...
            <div className="w-fit min-w-full mx-auto flex flex-col items-center justify-start transition-all duration-300 ease-in-out px-4">
              ...
              {activeDeptFilter === 'All' && (
                <div className="flex flex-col items-center relative pb-8">
                  {renderNodeCard({ name: "Ahmad Wahid",  
                ...
                <div className={`flex items-start justify-center transition-all duration-300 ${density.gap}`}>
                      ...
                      <div className="relative w-full flex justify-center">
                        ...
                        <div className={`flex pt-6 ${chartDensity === 'concise' ? 'gap-4' : 'gap-8'}`}>
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            {renderSubNodeCard({ name: "Sarah Lim",  
                              role: "Sr. Developer",  
                              id: "EMP-0285",  
                              dept: "Engineering" })}
                            ...
                            <div className="space-y-2 flex flex-col items-center relative">
                              {renderSubSubNodeCard({ name: "Hana",  
                                role: "Dev",  
                                id: "EMP-9005",  
                                dept: "Engineering" })}
                              {renderSubSubNodeCard({ name: "Zul M",  
                                role: "Dev",  
                                id: "EMP-9006",  
                                dept: "Engineering" })}
                              {/* More Capsule button */}
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            <div className="space-y-2 flex flex-col items-center">
                              {renderSubSubNodeCard({ name: "Irfan M",  
                                role: "Backend Dev",  
                                id: "EMP-9007",  
                                dept: "Engineering" })}
                              <div
                  ...
                  {(activeDeptFilter === 'All' || activeDeptFilter === 'Finance') && (
                    <div className="flex flex-col items-center relative">
                      ...
                      {/* CFO */}
                      {renderNodeCard({ name: "Rachel Tan",  
                        role: "CFO",  
                        id: "EMP-0030",  
                        dept: "Finance",  
                        members: "180 members" })}
                      ...
                      <div className="relative w-full flex justify-center">
                        ...
                        <div className={`flex pt-6 ${chartDensity === 'concise' ? 'gap-3' : 'gap-6'}`}>
                          ...
                          <div className="flex flex-col items-center">
                            <div className="h-6 w-0.5 bg-slate-200 absolute -top-6 left-1/2" />
                            {renderSubNodeCard({ name: "Amy Lee",  
                              role: "Payroll Mgr",  
                              id: "EMP-9008",  
                              dept: "Finance" })}
                          </div>
                      ...
                      <div className="relative w-full flex justify-center">
                        ...
                        <div className={`flex pt-6 ${chartDensity === 'concise' ? 'gap-3' : 'gap-6'}`}>
                          ...
                          <div className="flex flex-col items-center">
                            ...
                            {renderSubNodeCard({ name: "Maya Tan",  
                              role: "Recruiter",  
                              id: "EMP-0099",  
                              dept: "HR" })}
                          </div>
                    ...
                    <div className="flex flex-col items-center relative">
                      ...
                      <div className="relative w-full flex justify-center">
                        ...
                        <div className={`flex pt-6 ${chartDensity === 'concise' ? 'gap-3' : 'gap-6'}`}>
                          ...
                          <div className="flex flex-col items-center">
                            <div className="h-6 w-0.5 bg-slate-200 absolute -top-6 left-1/2" />
                            {renderSubNodeCard({ name: "Nadia C",  
                              role: "Brand Mgr",  
                              id: "EMP-0122",  
                              dept: "Marketing" })}
                          </div>
                  ...
                  {(activeDeptFilter === 'All' || activeDeptFilter === 'Operations') && (
                    <div className="flex flex-col items-center relative">
                      ...
                      {/* COO */}
                      {renderNodeCard({ name: "Malik Said",  
                        role: "COO",  
                        id: "EMP-0060",  
                        dept: "Operations",  
                        members: "261 members" })}
                      ...
                      <div className="relative w-full flex justify-center">
                        ...
                        <div className={`flex pt-6 ${chartDensity === 'concise' ? 'gap-3' : 'gap-6'}`}>
                          ...
                          <div className="flex flex-col items-center">
                            <div className="h-6 w-0.5 bg-slate-200 absolute -top-6 left-1/2" />
                            {renderSubNodeCard({ name: "Ahmad L",  
                              role: "Ops Lead",  
                              id: "EMP-0185",  
                              dept: "Operations" })}
                          </div>
                          ...
                          <div className="flex flex-col items-center">
                            <div className="h-6 w-0.5 bg-slate-200 absolute -top-6 left-1/2" />
                            {renderSubNodeCard({ name: "Zara Nor",  
                              role: "Logistics",  
                              id: "EMP-9011",  
                              dept: "Operations" })}
                          </div>
      ...
      <div id="replicated-chart-stats-footer" className="bg-[#fcfdfd] border border-slate-200/60 rounded-3xl p-6.5 shadow-2xs space-y-5">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-4">
          ...
          <div 
            ...
            className={`cursor-pointer bg-white border p-4 rounded-2xl shadow-3xs transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xs active:scale-98 relative overflow-hidden group ${
              activeDeptFilter === 'Engineering' ? 'border-novora ring-1 ring-novora' : 'border-slate-200/50 hover:border-blue-305 hover:border-blue-300'
            }`}
          >
            <div className="absolute top-0 left-0 right-0 h-1 bg-novora" />
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest leading-none">Engineering</p>
            <p className="text-2xl font-black text-novora mt-2.5 leading-none">{engineeringCount}</p>
          </div>
          ...
          <div 
            ...
            className={`cursor-pointer bg-[#f8fafc] border p-4 rounded-2xl shadow-3xs transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xs active:scale-98 relative overflow-hidden group ${
              activeDeptFilter === 'All' ? 'border-slate-700 ring-1 ring-slate-700' : 'border-slate-205 border-slate-200 hover:border-slate-350'
            }`}
          >

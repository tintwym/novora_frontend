...
export default function InteractiveDashboard() {
  ...
  const handleRunPayroll = () => {
    if (payrollStatus === 'Completed') return;
              ...
              <div className="bg-gradient-to-r from-blue-950/50 via-slate-900 to-slate-900 border border-blue-500/10 rounded-xl p-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                <div>
                  <h4 className="text-sm font-semibold text-slate-100 flex items-center gap-1.5">
                    Welcome to your automated HR cockpit <span className="animate-wave text-base">👋</span>
                  </h4>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <div className="relative flex-1 max-w-sm">
                  ...
                  <input
                    ...
                    className="w-full bg-slate-900 border border-slate-800 rounded-lg pl-9 pr-4 py-1.5 text-xs text-slate-200 placeholder-slate-500 focus:outline-none focus:border-novora transition-colors"
                  />
                </div>
              ...
              <div className="bg-slate-900/60 border border-slate-800 rounded-xl p-5 space-y-4">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                  ...
                  {payrollStatus === 'Completed' && (
                    <div className="bg-blue-500/15 text-blue-400 border border-blue-500/20 text-xs font-semibold px-4 py-2 rounded-lg flex items-center gap-1.5">
                      <Check className="w-4 h-4" /> Disbursed Successfully
                    </div>
                  )}
                </div>

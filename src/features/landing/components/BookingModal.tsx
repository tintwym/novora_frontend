            ...
            {step === 1 && (
              <form onSubmit={handleNextStep} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1">We'll customize your live walkthrough based on your exact company size and system challenges.</p>
                </div>
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1 max-w-sm mx-auto">
                    We have successfully reserved your 30-minute consultation slot. A calendar invite and Google Meet access payload has been sent to <span className="font-semibold text-slate-800">{formData.email}</span>.
                  </p>
                </div>

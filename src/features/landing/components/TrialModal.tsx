...
export default function TrialModal({ isOpen, onClose }: TrialModalProps) {
  ...
  const handleDeployWorkspace = () => {
    ...
    // Simulate multi-step Cloud deployment
    const timers = [
            ...
            {step === 1 && (
              <form onSubmit={handleNextStep} className="space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Configure your primary login credentials and secure subdomain. No credit card required.</p>
                </div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-100 placeholder-slate-600 focus:outline-none focus:border-novora"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-slate-950 border border-slate-800 rounded-xl px-3.5 py-2.5 text-xs text-slate-100 placeholder-slate-600 focus:outline-none focus:border-novora font-mono"
                    />
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2.5">
                  {[
                    ...
                    <button
                      key={mod.key}
                      onClick={() => setModules({ ...modules, [mod.key]: !modules[mod.key as keyof typeof modules] })}
                ...
                <div className="flex gap-3 mt-6">
                  ...
                  <button
                    ...
                    className="flex-[2] bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-xl text-xs flex items-center justify-center gap-1.5 transition-colors shadow-md cursor-pointer"
                  >
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className="text-xs text-slate-400 mt-1 max-w-xs mx-auto">
                        Your custom organization portal has been constructed and secured successfully. You can log in immediately.
                      </p>
                    </div>
                    ...
                    <div className="bg-slate-950 border border-slate-800 rounded-xl p-4 max-w-xs mx-auto text-left space-y-2 text-xs font-mono">
                      ...
                      <p className="text-slate-300">Password: <span className="text-blue-400">novora-trial-2026</span></p>
                    </div>
                    ...
                    <button
                      onClick={() => {
                        onClose();
                        // Scroll to dashboard to simulate entry!
                        const el = document.getElementById('interactive-dashboard');

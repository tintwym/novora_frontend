              ...
              <div className="bg-slate-50/50 p-4 border border-slate-100 rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="px-3.5 py-2 bg-[#2f66e0] text-white font-bold text-xs rounded-xl hover:bg-opacity-95 cursor-pointer"
                  >
                    Generate New
                  </button>
                </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 animate-in fade-in transition-all">
                ...
                <div className="bg-slate-50/50 rounded-2xl p-5 border border-slate-200 space-y-4">
                  ...
                  <div className="flex gap-2.5 pt-1.5">
                    <button onClick={saveTemplate} className="px-4 py-2 bg-[#2f66e0] text-white font-bold text-xs rounded-xl cursor-pointer hover:bg-opacity-95">
                      Save Template
                    </button>
                    <button
                      onClick={() => {
          ...
          <div className="space-y-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <button
                ...
                className="bg-[#2f66e0] text-white px-4 py-2.5 rounded-xl text-xs font-bold hover:bg-opacity-95 transition-all flex items-center justify-center gap-1.5 cursor-pointer inline-flex shadow-xs"
              >

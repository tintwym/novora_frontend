              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs font-semibold text-slate-700 bg-white border border-slate-200 hover:border-slate-350 focus:border-[#2f66e0] rounded-xl px-3 py-1.5 outline-none"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full text-xs font-bold text-slate-800 bg-white border border-slate-200 hover:border-slate-350 focus:border-[#2f66e0] rounded-xl px-3 py-2 outline-none"
                  />
                </div>
                <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3.5">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full text-xs font-bold text-slate-800 bg-white border border-slate-205 rounded-lg px-3 py-1.5 focus:border-[#2f66e0] outline-none"
                        />
                      </div>
                      <div>
                        ...
                        <input
                          ...
                          className="w-full text-xs font-semibold text-slate-800 bg-white border border-slate-205 rounded-lg px-3 py-1.5 focus:border-[#2f66e0] outline-none"
                        />
                      </div>
                    </div>
                  </div>
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-between items-center">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-4.5 py-2 bg-[#2f66e0] hover:bg-opacity-95 text-white font-extrabold rounded-xl transition-all text-xs"
                >
                  Save matrix
                </button>
              </div>
          ...
          <div className="bg-white rounded-2xl max-w-md w-full border border-slate-200 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-150">
            ...
            <div className="px-6 py-4 bg-slate-50 border-t border-slate-100 flex justify-end gap-2">
              ...
              <button
                ...
                className="px-4.5 py-2 bg-[#2f66e0] hover:bg-opacity-95 text-white font-extrabold rounded-xl transition-all text-xs cursor-pointer"
              >
                Save limits
              </button>
            </div>
              ...
              <div className="border-t border-slate-100 pt-3.5 space-y-2">
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 text-xs font-semibold text-slate-800 bg-white border border-slate-205 rounded-xl px-3 py-2 outline-none focus:border-[#2f66e0]"
                  />
                  <button
                    onClick={() => {

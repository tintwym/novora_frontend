  ...
  return (
    <div id="payroll-panel-view" className="space-y-6 animate-in fade-in duration-150">
      ...
      <div id="payroll-module-navigator" className="flex flex-col lg:flex-row lg:items-center justify-between border-b border-slate-200/85 pb-4 gap-4">
        ...
        <div id="payroll-navigation-tabs" className="flex items-center gap-2 select-none overflow-x-auto w-full lg:w-auto scrollbar-none pb-1 lg:pb-0">
          {mainTabs.map((tab) => {
            const Icon = tab.icon;
        ...
        {activeMainTab === 'Allowance' && (
          <div id="allowance-view-container" className="space-y-6 font-sans">
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-extrabold px-4 py-2.5 rounded-xl shadow-tiny inline-flex items-center gap-1.5 self-end sm:self-auto cursor-pointer"
                  >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-slate-50 border border-slate-200 p-5 rounded-2xl space-y-4">
                    ...
                    <form onSubmit={(e) => {
                      ...
                      <button type="submit" className="w-full bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-bold py-2.5 rounded-xl cursor-pointer">
                        File Reimbursement
                      </button>
                    </form>
                  </div>
            ...
            {allowanceSubTab === 'Allowance payment' && (
              <div className="space-y-4">
                <div className="bg-gradient-to-r from-blue-50 to-[#2f66e0]/5 p-4 rounded-2xl border border-blue-100 flex flex-col md:flex-row justify-between items-center gap-3">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-extrabold text-xs px-4 py-2 rounded-xl shrink-0 cursor-pointer"
                  >
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-3 bg-slate-50/50 p-4 border border-slate-200 rounded-3xl">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-bold px-4 py-2 rounded-xl cursor-pointer"
                  >
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-bold px-3.5 py-1.5 rounded-xl cursor-pointer"
                  >
                    + Add New Policy Rule
                  </button>
                </div>
                ...
                <div className="lg:col-span-3 space-y-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="bg-blue-50 text-[#2f66e0] font-black text-[9px] px-2 py-0.5 rounded border border-blue-105">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-extrabold px-4 py-2.5 rounded-xl shadow-tiny inline-flex items-center gap-1.5 cursor-pointer"
                  >
                    <Plus className="h-4 w-4" />
                    ...
                    <tbody className="divide-y divide-slate-100 font-medium text-slate-705">
                      {depositTypes.map((dep) => (
                        <tr key={dep.id} className="hover:bg-slate-50/50">
                          ...
                          <td className="p-4">
                            <span className="bg-blue-50/70 text-[#2f66e0]/90 border border-blue-105 rounded-md px-2 py-0.5 text-[10px] font-bold">
              ...
              <div className="space-y-4">
                <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-extrabold px-4 py-2.5 rounded-xl shadow-tiny inline-flex items-center gap-1.5 cursor-pointer self-end sm:self-auto"
                  >
                    <Plus className="h-4 w-4" />
                      ...
                      {deductions
                        ...
                        .map((ded) => (
                          <tr key={ded.id} className="hover:bg-slate-50/50">
                            ...
                            <td className="p-4">
                              <span className="bg-blue-50/70 text-[#2f66e0] border border-blue-105 rounded-md px-2 py-0.5 text-[10px] font-bold">
                                {ded.type}
                              </span>
                            </td>
                ...
                <div className="border border-slate-150 rounded-2xl p-5 bg-white space-y-3">
                  ...
                  <div className="pt-2">
                    <button
                      ...
                      className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-bold px-4 py-2 rounded-xl cursor-pointer"
                    >
              ...
              <div className="space-y-4 text-xs font-semibold">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-bold px-3 py-1.5 rounded-xl cursor-pointer"
                  >
            ...
            {payMgmtSubTab === 'Payroll preparation' && (
              <div className="space-y-4">
                <div className="flex bg-slate-50 border border-slate-200 p-4 rounded-xl justify-between items-center text-xs">
                  ...
                  <button type="button" onClick={() => addToast('Pushed payroll parameters check to external accounting system.', 'success')} className="bg-[#2f66e0] hover:bg-opacity-95 text-white font-bold py-1.5 px-3 rounded-lg cursor-pointer">
                    Validate Roster
                  </button>
                </div>
            ...
            {payMgmtSubTab === 'Payroll run' && (
              <div className="space-y-6 text-xs max-w-xl mx-auto border border-slate-200 bg-white p-6 rounded-3xl">
                ...
                <button
                  ...
                  className="w-full bg-[#2f66e0] hover:bg-opacity-95 text-white font-extrabold text-xs py-3.5 rounded-2xl shadow-xs transition-transform cursor-pointer"
                >
          ...
          <div className="bg-white border border-slate-150 rounded-3xl p-6 shadow-2xl max-w-md w-full space-y-5 animate-in zoom-in-95 duration-200">
            ...
            <div className="space-y-2">
              ...
              <div className="h-2 w-full bg-slate-100 rounded-lg overflow-hidden">
                <div
                  className="h-full bg-gradient-to-r from-blue-500 to-[#2f66e0] transition-all duration-300 rounded-lg"
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 bg-[#2f66e0] hover:bg-opacity-95 text-white disabled:opacity-50 text-xs font-extrabold py-2.5 rounded-xl cursor-pointer"
              >
        ...
        <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center z-50 p-4">
          <form onSubmit={handleAddNewAllowance} className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl max-w-sm w-full space-y-4 font-sans animate-in zoom-in-95 duration-150">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                type="submit"
                className="flex-1 bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-bold py-2 px-4 rounded-xl cursor-pointer"
              >
                Register Policy
              </button>
            </div>
          ...
          <div className="bg-white border border-slate-200 rounded-3xl p-6 shadow-xl max-w-sm w-full space-y-4 font-sans animate-in zoom-in-95 duration-150">
            ...
            <div className="flex gap-2 pt-2">
              ...
              <button
                ...
                className="flex-1 bg-[#2f66e0] hover:bg-opacity-95 text-white text-xs font-bold py-2.5 px-4 rounded-xl cursor-pointer"
              >
                Confirm Commit
              </button>
            </div>

...
export default function OnOffBoardingTab({ employees, addToast }: OnOffBoardingTabProps) {
  ...
  const [grRating, setGrRating] = useState(4);
  ...
  // E-Signature
  const handleEsignContract = (e: React.FormEvent) => {
    e.preventDefault();
    ...
    addToast(`Offer contract securely digitally sealed under certificate key code [SEC-${createLocalId('sec')}]`, 'success');
  };
  ...
  const handleResigSubmit = (e: React.FormEvent) => {
    e.preventDefault();
                ...
                {isOfferSigned ? (
                  <div className="bg-emerald-50/50 border border-emerald-200/60 p-5 rounded-xl text-center">
                    ...
                    <button 
                      ...
                      className="text-xs text-novora font-bold hover:underline mt-3 flex items-center gap-1 mx-auto"
                    >
                  ...
                  <form onSubmit={handleEsignContract} className="space-y-4">
                    ...
                    <div className="flex justify-end">
                      <button
                        type="submit"
                        className="bg-novora hover:bg-opacity-95 text-white text-xs font-extrabold px-5 py-2.5 rounded-xl cursor-pointer shadow-xs transition-transform flex items-center gap-2"
                      >
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="nv-card p-6 shadow-xs">
                ...
                <form onSubmit={handleDocUpload} className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-novora hover:bg-opacity-95 text-white text-xs font-extrabold py-2.5 rounded-xl transition-all cursor-pointer shadow-xs flex items-center justify-center gap-2"
                  >
              ...
              <div className="bg-novora/5 border border-novora/10 p-5 rounded-2xl">
            ...
            <div className="nv-card p-6 shadow-xs">
              ...
              <div className="flex items-center gap-3 mt-4">
                <div className="w-full bg-slate-100 rounded-full h-2 overflow-hidden">
                  <div 
                    className="bg-novora h-full transition-all duration-550" 
            ...
            <div className="nv-card p-6 shadow-xs">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-5">
                ...
                <button
                  ...
                  className="text-xs text-novora hover:underline font-extrabold flex items-center gap-1 shrink-0"
                >
              ...
              {targetedChecklists.length === 0 ? (
                ...
                <div className="space-y-3">
                  {targetedChecklists.map((item) => (
                    ...
                    >
                      <div className="flex items-start gap-3.5">
                        <span className="mt-0.5 text-novora shrink-0">
                          {item.completed ? (
                      ...
                      <div
                        ...
                        className={`p-4 rounded-xl border transition-all cursor-pointer text-left select-none ${
                          selectedKbArticle === art.id
                            ? 'bg-blue-50/30 border-novora/35 hover:border-novora/45'
                            : 'bg-white border-slate-100 hover:border-slate-200'
                        }`}
                      >
                        <div className="flex justify-between items-start gap-2">
                          <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-md ${
                            art.category === 'Policy' ? 'bg-indigo-50 text-novora' : 'bg-amber-50 text-amber-700'
                          }`}>
                            {art.category}
                          </span>
                        ...
                        <div className="mt-3 pt-3 border-t border-slate-50 flex justify-between items-center text-[10px] font-bold text-novora">
                ...
                <div className="relative aspect-video rounded-xl bg-slate-900 overflow-hidden flex flex-col justify-center items-center text-center p-4">
                  {isVideoPlaying ? (
                    ...
                    <div className="space-y-2">
                      <Video className="h-9 w-9 text-novora" />
                      ...
                      <button
                        ...
                        className="bg-novora hover:bg-opacity-95 text-white font-extrabold text-[10.5px] px-3.5 py-1.5 rounded-lg cursor-pointer transition-all mt-2.5 flex items-center gap-1.5 mx-auto"
                      >
                      ...
                      {resignationCases.map(c => (
                        <tr 
                          ...
                          className={`cursor-pointer transition-colors ${
                            selectedResigId === c.id ? 'bg-novora/5' : 'hover:bg-slate-50/50'
                          }`}
                        >
        ...
        <div id="subview-exitinterviews" className="space-y-6">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="nv-card p-6 shadow-xs">
                <div className="flex items-center gap-2 mb-4">
                  <BarChart2 className="h-4 w-4 text-novora" />
                ...
                <div className="bg-blue-50/50 rounded-xl p-4 border border-blue-100/50 text-[11px] leading-relaxed text-slate-600 mt-5">
                  <span className="font-extrabold text-novora">Top Departure Trigger:</span>
            ...
            <div className="lg:col-span-7 bg-white border border-slate-100 rounded-3xl p-6 shadow-3xs space-y-5">
              <div className="border-b border-slate-50 pb-3 flex justify-between items-center">
                ...
                <button 
                  ...
                  className="bg-slate-50 border border-slate-100 rounded-xl px-2.5 py-1 text-[9.5px] font-black uppercase text-slate-500 hover:text-novora transition-colors cursor-pointer"
                >
                  ...
                  {['IT Operations', 'HR Compliance', 'Finance Payroll', 'Security Assets', 'Engineering department', 'HR Administration'].map((dept) => {
                    ...
                    return (
                      <div key={dept} className="space-y-1">
                        ...
                        <div className="w-full bg-slate-100 h-1.5 rounded-full overflow-hidden">
                          <div 
                            className="bg-novora h-full rounded-full transition-all duration-300" 

                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="bg-slate-50 border border-slate-200 focus:border-[#2f66e0] rounded-xl pl-8.5 pr-7 py-1.5 text-xs font-semibold text-slate-700 outline-none w-56"
                      />
                      {reportSearchQuery && (
                        <button
          ...
          <div id="new-req-modal-panel" className="bg-white text-slate-800 rounded-3xl w-full max-w-4xl shadow-2xl border border-slate-200 overflow-hidden transform animate-in fade-in duration-200 max-h-[calc(100vh-2rem)] flex flex-col">
            ...
            <div className="px-5 sm:px-6 py-3.5 border-b border-slate-100 bg-slate-50 flex items-center justify-between select-none text-xs font-bold shrink-0">
              <div className="flex items-center gap-2.5">
                <span className={`h-6 w-6 rounded-full flex items-center justify-center font-bold text-xs ${
                  requisitionStep === 1 
                    ...
                    : 'bg-[#2f66e0]/20 text-[#2f66e0] border border-[#2f66e0]/30'
                }`}>
                  {requisitionStep > 1 ? '✓' : '1'}
                </span>
                <span className={requisitionStep === 1 ? 'text-[#2f66e0] font-semibold' : 'text-slate-400'}>
                  Position details
                </span>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className={requisitionStep === 2 ? 'text-[#2f66e0] font-semibold' : 'text-slate-400'}>
                  Requirements &amp; JD
                </span>
              </div>
              ...
              <div className="flex items-center gap-2.5">
                ...
                <span className={requisitionStep === 3 ? 'text-[#2f66e0] font-semibold' : 'text-slate-400'}>
                  Approval &amp; routing
                </span>
              </div>
            </div>
            ...
            <form onSubmit={(e) => e.preventDefault()} className="flex-1 min-h-0 overflow-y-auto p-5 sm:p-6">
              ...
              {requisitionStep === 1 && (
                <div className="space-y-6 animate-in fade-in duration-150">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-5 text-xs">
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] focus:ring-1 focus:ring-[#2f66e0]/50 font-semibold"
                          required
                        />
                      </div>
                      <div>
                        ...
                        <select
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] font-semibold"
                        >
                          <option value="HR">Human Resources</option>
                  ...
                  <div className="border-t border-slate-100 pt-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-5 text-xs">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] font-semibold"
                          required
                        />
                      </div>
                      <div>
                    ...
                    <div className="mt-5 text-xs">
                      ...
                      <textarea
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 outline-none focus:border-[#2f66e0] font-semibold"
                      />
                    </div>
                  </div>
                  ...
                  <div className="sticky bottom-0 z-10 -mx-5 sm:-mx-6 px-5 sm:px-6 py-3.5 mt-4 border-t border-slate-100 bg-white/95 backdrop-blur-xs flex items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-3 shrink-0">
                      ...
                      <button
                        ...
                        className="px-4 py-2 text-xs font-bold rounded-xl bg-[#2f66e0] hover:bg-opacity-95 text-white cursor-pointer transition-all flex items-center gap-1.5"
                      >
                        <span>Next</span>
              ...
              {requisitionStep === 2 && (
                <div className="space-y-6 animate-in fade-in duration-150">
                  ...
                  <div className="border-t border-slate-100 pt-6">
                    <label className="block text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-3">
                      Skills Required
                    </label>
                    ...
                    <div className="flex flex-wrap gap-2 mb-3.5">
                      {reqForm.skills.map((skill) => (
                        <div
                          key={skill}
                          className="bg-[#2f66e0]/15 text-[#2f66e0] border border-[#2f66e0]/25 text-xs font-bold px-3 py-1.5 rounded-xl flex items-center gap-2"
                        >
                          <span>{skill}</span>
                          <button
                            type="button"
                            ...
                            className="hover:bg-[#2f66e0]/20 text-blue-400 hover:text-slate-800 rounded-md px-1 select-none font-bold"
                          >
                            ✕
                          </button>
                        </div>
                    ...
                    <div className="flex items-center gap-3 max-w-lg">
                      <input
                        ...
                        className="flex-1 bg-slate-50 border border-slate-200 rounded-xl px-4 py-2 text-xs text-slate-800 outline-none focus:border-[#2f66e0] font-semibold"
                      />
                      <button
                        type="button"
                        onClick={() => {
                        ...
                        className="bg-[#2f66e0]/10 border border-[#2f66e0]/25 text-[#2f66e0] hover:bg-[#2f66e0] hover:text-white transition-all font-bold text-xs px-3.5 py-2 rounded-xl cursor-pointer"
                      >
                        + Add skill
                      </button>
                    </div>
                    ...
                    <div className="space-y-4 text-xs">
                      <div>
                        ...
                        <textarea
                          ...
                          className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 outline-none focus:border-[#2f66e0] font-mono leading-relaxed font-semibold"
                          required
                        />
                      </div>
                      <div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-xs text-slate-600 font-semibold select-none">
                      <label className="flex items-center gap-3 cursor-pointer bg-slate-50 p-3 rounded-xl border border-slate-200 hover:border-slate-300 transition-colors">
                        <input
                          ...
                          className="h-4.5 w-4.5 text-[#2f66e0] rounded bg-white border-slate-300 focus:ring-[#2f66e0]"
                        />
              ...
              {requisitionStep === 3 && (
                <div className="space-y-6 animate-in fade-in duration-150">
                  ...
                  <div>
                    <h3 className="text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-2">
                      Approval Chain
                    </h3>
                    ...
                    <div className="space-y-3 font-semibold text-xs text-slate-500 select-none">
                      ...
                      <div className="bg-slate-50 border border-slate-200 rounded-2xl p-4 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                          <span className="h-7 w-7 rounded-lg bg-[#2f66e0]/20 text-[#2f66e0] flex items-center justify-center font-bold text-xs border border-[#2f66e0]/40">
                            1
                          </span>
                          <div>
                  ...
                  <div className="bg-slate-50 rounded-2xl p-5 border border-slate-200 text-xs">
                    <h4 className="font-extrabold text-[#2f66e0] border-b border-slate-100 pb-2 mb-3 tracking-wide">
                      Requisition summary
                    </h4>
          ...
          <div className="bg-white rounded-3xl w-full max-w-xl shadow-2xl border border-slate-100 overflow-hidden transform animate-in fade-in-50 zoom-in-95 duration-200">
            ...
            <form onSubmit={handleCreatePosting} className="p-6 space-y-4 text-xs font-semibold">
              ...
              <div className="border-t border-slate-50 pt-4 flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 px-4 py-2 text-xs font-bold rounded-xl bg-[#2f66e0] hover:bg-opacity-95 text-white cursor-pointer transition-all text-center"
                >
                  Publish ad posting
                </button>
              </div>
        ...
        <div id="new-cand-modal-backdrop" className="fixed inset-0 bg-slate-900/60 backdrop-blur-xs flex items-center justify-center p-4 z-50">
          <div id="new-cand-modal-panel" className="bg-white text-slate-800 rounded-3xl w-full max-w-2xl shadow-2xl border border-slate-200 overflow-hidden transform animate-in fade-in duration-200 max-h-[calc(100vh-2rem)] flex flex-col">
            ...
            <div className="border-b border-slate-100 px-5 sm:px-6 py-4 flex items-center justify-between shrink-0 bg-slate-50">
              <div>
                <h2 className="text-lg font-bold text-slate-800 tracking-tight flex items-center gap-2">
                  <UserPlus className="h-5 w-5 text-[#2f66e0]" />
            ...
            <form onSubmit={handleCreateCandidate} className="flex-1 min-h-0 overflow-y-auto p-5 sm:p-6 space-y-6">
              ...
              {/* Block 1: Basic Info */}
              <div>
                <h3 className="text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-4 flex items-center gap-1.5">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
                  <div className="sm:col-span-2">
                    ...
                    <input
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] transition-all"
                      required
                    />
                  </div>
                  <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] transition-all font-semibold"
                    >
                  ...
                  <div>
                    ...
                    <select className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] transition-all font-semibold">
              ...
              <div className="border-t border-slate-100 pt-6">
                <label className="block text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-2.5">
                  Document Attachments
                </label>
                <div className="border border-dashed border-slate-200 hover:border-[#2f66e0]/40 bg-slate-50 rounded-2xl p-6 text-center cursor-pointer transition-all group">
                  <Upload className="h-8 w-8 text-slate-500 group-hover:text-[#2f66e0] mx-auto mb-2 transition-colors" />
            ...
            <div className="border-b border-slate-100 px-5 sm:px-6 py-4 flex items-center justify-between shrink-0 bg-slate-50">
              <div>
                <h2 className="text-lg font-bold text-slate-800 tracking-tight flex items-center gap-2.5">
                  <Calendar className="h-5 w-5 text-[#2f66e0]" />
                ...
                <div className="lg:col-span-8 space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] font-semibold text-xs transition-all"
                      required
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 text-xs font-semibold">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-[#2f66e0]/40 rounded-xl px-4 py-2.5 text-[#2f66e0] font-mono font-bold outline-none focus:border-[#2f66e0]"
                      />
                    </div>
                  </div>
                  ...
                  <div className="border-t border-slate-100 pt-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
                      ...
                      <div className="flex items-center gap-2 text-[11px] text-slate-400 select-none">
                        <span className="h-6 w-6 rounded-full bg-[#2f66e0]/10 text-[#2f66e0] flex items-center justify-center font-bold shrink-0">NR</span>
                  ...
                  {/* Invitation notes */}
                  <div className="border-t border-slate-100 pt-6">
                    <label className="block text-xs font-bold text-[#2f66e0] uppercase tracking-wider mb-2">
                    ...
                    <textarea
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-3 text-slate-800 outline-none focus:border-[#2f66e0] text-xs font-semibold"
                    />
                  </div>
                  ...
                  <div className="bg-slate-50 p-4 border border-slate-200 rounded-2xl flex flex-col sm:flex-row gap-4 select-none text-[11px] font-bold text-slate-600">
                    <label className="flex items-center gap-2.5 cursor-pointer">
                      <input
                        ...
                        className="h-4 w-4 text-[#2f66e0] bg-white border-slate-300 rounded focus:ring-blue-500"
                      />
                ...
                <div className="lg:col-span-4 bg-slate-50 border border-slate-100 p-6 rounded-2xl text-xs space-y-5 select-none font-semibold">
                  ...
                  <div className="space-y-3">
                    <div className="flex justify-between text-[11px] text-slate-400">
                      ...
                      <span className="text-[#2f66e0] font-mono">20 Jun 2026</span>
                    </div>
                    ...
                    <div className="space-y-2 font-mono text-[10.5px]">
                      ...
                      <div className="p-2 border-l-2 border-[#2f66e0] bg-[#2f66e0]/15 rounded flex justify-between items-center text-[#2f66e0] font-bold">
                ...
                <div className="lg:col-span-6 space-y-6">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-slate-50 border border-slate-200 rounded-xl px-3.5 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] font-bold text-xs"
                      required
                    >
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs font-semibold">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0]"
                    ...
                    <div>
                      ...
                      <select
                        ...
                        className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-800 outline-none focus:border-[#2f66e0] font-semibold text-xs"
                      >
                  ...
                  <div className="border-t border-slate-100 pt-5 space-y-2">
                    ...
                    <input
                      ...
                      className="w-full accent-[#2f66e0] cursor-pointer bg-slate-200 h-1.5 rounded-lg"
                    />
                  </div>

    ...
    <div id="recruitment-module-stage" className="space-y-6">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-xs flex items-center justify-between">
              <div className="relative w-72">
                ...
                <input
                  ...
                  className="w-full bg-slate-50 border border-slate-150 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-700 outline-none focus:border-slate-300 focus:bg-white transition-all"
                />
              </div>
                      ...
                      <tr key={req.id} className="hover:bg-slate-50/50 transition-colors">
                        ...
                        <td className="py-3.5 px-5 text-right">
                          <button
                            ...
                            className="bg-slate-50 hover:bg-[#2f66e0]/10 hover:text-[#2f66e0] transition-colors border border-slate-150 px-2.5 py-1.5 rounded-lg text-[11px] font-semibold flex items-center gap-1.5 ml-auto text-slate-600 cursor-pointer"
                          >
            ...
            <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-xs flex flex-wrap items-center justify-between gap-4">
              ...
              <div className="relative w-64">
                ...
                <input
                  ...
                  value={searchValue}
                  onChange={(e) => setSearchValue(e.target.value)}
                  className="w-full bg-slate-50 border border-slate-150 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-750 outline-none focus:border-slate-300 focus:bg-white transition-all"
                />
              </div>
            </div>
                ...
                <div className="flex flex-wrap items-center gap-3.5 w-full sm:w-auto">
                  ...
                  <div className="flex flex-col">
                    ...
                    <select
                      ...
                      className="bg-white border border-slate-200 hover:border-slate-350 rounded-xl px-3 py-1.5 text-xs text-slate-700 font-bold outline-none cursor-pointer"
                    >
                  ...
                  <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-xs font-semibold">
                    ...
                    <div className="mt-4.5 pt-4.5 border-t border-slate-100 space-y-3 font-semibold text-xs text-slate-600">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="text-slate-850 font-bold">{stats.offers}</span>
                      </div>
                      <div className="flex justify-between">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="bg-slate-50 border border-slate-200 focus:border-slate-350 rounded-xl pl-8.5 pr-7 py-1.5 text-xs font-semibold text-slate-700 outline-none w-56"
                      />
                      {reportSearchQuery && (
                        <button
      ...
      {requisitionModalOpen && (
        <div id="new-req-modal-backdrop" className="fixed inset-0 bg-[#070b13]/85 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div id="new-req-modal-panel" className="bg-[#111827] text-[#e2e8f0] rounded-3xl w-full max-w-4xl shadow-2xl border border-slate-800 overflow-hidden transform animate-in fade-in duration-200 my-8">
      ...
      {candidateModalOpen && (
        <div id="new-cand-modal-backdrop" className="fixed inset-0 bg-[#070b13]/85 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div id="new-cand-modal-panel" className="bg-[#111827] text-[#e2e8f0] rounded-3xl w-full max-w-2xl shadow-2xl border border-slate-800 overflow-hidden transform animate-in fade-in duration-200 my-8">
      ...
      {interviewModalOpen && (
        <div id="new-interview-modal-backdrop" className="fixed inset-0 bg-[#070b13]/85 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div id="new-interview-modal-panel" className="bg-[#111827] text-[#e2e8f0] rounded-3xl w-full max-w-4xl shadow-2xl border border-slate-800 overflow-hidden transform animate-in fade-in duration-200 my-8">
      ...
      {offerModalOpen && (
        <div id="new-offer-modal-backdrop" className="fixed inset-0 bg-[#070b13]/85 backdrop-blur-md flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div id="new-offer-modal-panel" className="bg-[#111827] text-[#e2e8f0] rounded-3xl w-full max-w-5xl shadow-2xl border border-slate-800 overflow-hidden transform animate-in fade-in duration-200 my-8">
